...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g){
        ...
        g.drawString("Score: "+dotEaten, (SCREEN_WIDTH - metrics.stringWidth("Score: "+dotEaten))/2, g.getFont().getSize());
    }
    public void newDot(){
    ...
    public void gameOver(Graphics g){
        ...
        g.drawString("Score: "+dotEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: "+dotEaten))/2, g.getFont().getSize());
        g.setColor(Color.red);
